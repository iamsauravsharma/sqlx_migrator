...
```toml
sqlx_migrator = { version = "0.11.4", features=["postgres"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.4", features=["mysql"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.4", features=["sqlite"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.4", features=[
    "any",
