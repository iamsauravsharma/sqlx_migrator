...
```toml
sqlx_migrator = { version = "0.9.1", features=["postgres"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.1", features=["mysql"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.1", features=["sqlite"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.1", features=[
    "any",
