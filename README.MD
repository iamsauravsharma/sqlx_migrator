...
```toml
sqlx_migrator = { version = "0.11.3", features=["postgres"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.3", features=["mysql"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.3", features=["sqlite"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.3", features=[
    "any",
