...
```toml
sqlx_migrator = { version = "0.11.2", features=["postgres"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.2", features=["mysql"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.2", features=["sqlite"] }
```

OR

```toml
sqlx_migrator = { version = "0.11.2", features=[
    "any",
