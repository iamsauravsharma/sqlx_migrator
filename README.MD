...
```toml
sqlx_migrator = { version = "0.9.0", features=["postgres"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.0", features=["mysql"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.0", features=["sqlite"] }
```

OR

```toml
sqlx_migrator = { version = "0.9.0", features=[
    "any",
